...
import com.vivek.response.ApiResponse;
import com.vivek.response.AuthResponse;
import com.vivek.service.*;
import com.vivek.service.impl.CustomeUserServiceImplementation;
import com.vivek.utils.OtpUtils;
...
//        Seller savedSeller = sellerService.createSeller(seller);
    ...
    public ResponseEntity<Seller> createSeller(@RequestBody Seller seller) throws SellerException, MessagingException {
        ...
        String subject = "Viva Bazaar Email Verification Code";
        String text = "Welcome to Viva Bazaar, verify your account using this link ";
        String frontend_url = frontendUrl+"/seller-account-verified/";
